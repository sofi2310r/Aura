...
export class ForoService {
  ...
  agregarComentario(
    ...
    const Comentario: Comentario = {
      ...
      publicacionAutorUid: (input as any).publicacionAutorUid || '',
  ...
  private forceRefresh(): void {
    this.backend
      ...
      .subscribe((publicaciones) => {
        const signature = this.buildPublicacionesSignature(publicaciones);
        this.lastPublicacionesSignature = signature; // Forzar actualización
        this.publicacionesSubject.next(publicaciones);
      });
  }
